...
主清单中的非综述论文必须正式发表于指定顶级会议的主会：**ACL、EMNLP、NAACL、AAAI、SIGIR 或 CIKM**。综述论文是唯一例外。Workshop、Findings、Industry Track、LREC 和仅有预印本的方法论文不纳入主清单。通用 RAG、通用智能体、角色扮演和传统推荐论文，若未明确研究用户特定适配，也不在收录范围内。
